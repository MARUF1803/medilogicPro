...
public partial class ApplicationDbContext : DbContext
{
    ...
    public ApplicationDbContext(DbContextOptions<ApplicationDbContext> options, ICurrentBranchService? branchService = null)
        : base(options)
    {
        _branchService = branchService;
        _currentBranchId = _branchService?.GetCurrentBranchId();
    }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            modelBuilder.Entity<BatchStock>().HasQueryFilter(e => e.BranchId == _currentBranchId);
            modelBuilder.Entity<SalesMaster>().HasQueryFilter(e => e.BranchId == _currentBranchId);
            modelBuilder.Entity<PurchaseMaster>().HasQueryFilter(e => e.BranchId == _currentBranchId);
            modelBuilder.Entity<SalesReturnMaster>().HasQueryFilter(e => e.BranchId == _currentBranchId);
            modelBuilder.Entity<PurchaseReturnMaster>().HasQueryFilter(e => e.BranchId == _currentBranchId);
            modelBuilder.Entity<Ledger>().HasQueryFilter(e => e.BranchId == _currentBranchId);
            modelBuilder.Entity<Party>().HasQueryFilter(e => e.BranchId == _currentBranchId);
            modelBuilder.Entity<Product>().HasQueryFilter(e => e.BranchId == _currentBranchId);
        }
        ...
        modelBuilder.Entity<Party>(entity =>
        {
            ...
            entity.Property(e => e.CreditBalance).HasDefaultValue(0m).HasColumnType("decimal(18, 2)");
        ...
        modelBuilder.Entity<Product>(entity =>
        {
            ...
            entity.HasOne(d => d.Branch).WithMany(p => p.Products).HasForeignKey(d => d.BranchId).HasConstraintName("FK__Product__BranchId");
        });
        ...
        modelBuilder.Entity<PurchaseDetail>(entity =>
        {
            ...
            entity.Property(e => e.ReturnedQuantity).HasDefaultValue(0m).HasColumnType("decimal(18, 2)");
        ...
        modelBuilder.Entity<SalesPayment>(entity =>
        {
            ...
            entity.Property(e => e.PaymentProvider).HasMaxLength(100);
            entity.HasOne(d => d.Sales).WithMany(p => p.SalesPayments).HasForeignKey(d => d.SalesId);
        });
        ...
        modelBuilder.Entity<PurchasePayment>(entity =>
        {
            ...
            entity.Property(e => e.PaymentNote).HasMaxLength(500);
            entity.Property(e => e.PaymentProvider).HasMaxLength(100);
            entity.HasOne(d => d.Purchase).WithMany(p => p.PurchasePayments).HasForeignKey(d => d.PurchaseId);
        });
        ...
        {
            entity.HasKey(e => e.LedgerId).HasName("PK__Ledger__3214EC07");
